...
define('THUMBNAIL_WIDTH', 400); //400px
define('UPLOAD_DIR', __DIR__ . '/upload'); //ディレクトリ
define('THUMBNAIL_DIR', __DIR__ . '/thumbnail');
...
<body id="main">
    ...
    <ul>
        <?php foreach($images as $image) : ?>
            <li>
                <a href="<?php echo h(basename(UPLOAD_DIR)) . '/' . h(basename($image)); ?>">
                <div class="waku">
                    <div id="packery">
                        <div class="item w1"><img src="<?php echo h($image); ?>"></div>
                    </div>
                </div>
                </a>
            </li>
